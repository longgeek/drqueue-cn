...
typedef enum miModule {
	...
	miM_RCH   = miM_RCLM + 2, /* Hair rendering */
	...
	miM_HALF = miM_COMP + 4,/* 16-bit float type */
	miM_RCMAP,		/* RC map */
...
typedef enum miScene_types {
	...
	miSCENE_NBOX,		/* 40: new miBox, replaces miGeoBox/miSCENE_BOX*/
...
struct miOptions {
	...
	miTag		images_info;		/* deprecated 0 frame buffers */
