...
enum miObject_type {
	...
	miOBJECT_HAIR			= 7,
	miOBJECT_INTERSECT_FUNC		= 8	/* custom type */
};
...
typedef struct miHair_list {
	...
	miInteger	spare0; 		/* not used, former approx */
...
#define miEO_MAP_DECL	   0x00010000		/* map declaration */
#define miEO_MAP	   0x00020000		/* map */
