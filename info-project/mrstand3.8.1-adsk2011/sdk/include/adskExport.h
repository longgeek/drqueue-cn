...
#define ADSK_SHADERSDK_CPP_EXPORT __declspec(dllexport)
#else
#define ADSK_SHADERSDK_EXPORT EXTERN_C __declspec(dllimport)
#define ADSK_SHADERSDK_CPP_EXPORT __declspec(dllimport)
#endif // defined(ADSKSHADERSDK_DLL)
#else
#if (defined(LINUX) || defined(MACOSX))
#define ADSK_SHADERSDK_EXPORT EXTERN_C __attribute__ ((visibility ("default")))
#define ADSK_SHADERSDK_CPP_EXPORT __attribute__ ((visibility ("default")))
#else
#define ADSK_SHADERSDK_EXPORT EXTERN_C
#define ADSK_SHADERSDK_CPP_EXPORT 
