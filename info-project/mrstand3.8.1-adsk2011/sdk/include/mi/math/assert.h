...
/// \brief Assertions and compile-time assertions, see \ref mi_math_assert.
///
//*****************************************************************************
...
/** \defgroup mi_math_assert \MathApiName Assertions
    ...
    \MathApiName supports quality software development with assertions.
    ...
    or correspondingly the  \c mi_base_assert and \c mi_base_assert_msg
...
/// be disabled.
///
/// By default, this macro maps to \c mi_base_assert, which in turn
...
///
/// \see \ref mi_math_intro_assert and  \ref mi_base_intro_assert
...
///
/// By default, this macro maps to \c mi_base_assert_msg, which in turn
/// does nothing by default. You can (re-)define this macro
/// to perform possible checks and diagnostics within the specification
/// given in the previous paragraph.
///
...
/// defined if and only if you (re-)defined \c mi_math_assert and
/// \c mi_math_assert_msg (or \c mi_base_assert and
/// \c mi_base_assert_msg). Note that you can not simply test for
/// \c mi_math_assert or \c mi_math_assert_msg, since these macros get
